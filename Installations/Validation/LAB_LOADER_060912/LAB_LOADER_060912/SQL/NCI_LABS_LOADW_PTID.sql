...
SPOOL NCI_LABS_LOADW_&PTID;

DEFINE studytitle =  "LAB_LOADER - NCI_LABS - LOAD FLAG=W - Patient &&PTID"
DEFINE filename = "File: NCI_LABSS_LOADW_PTID"
DEFINE Progname = "SQl script: NCI_LABS_LOADW_PTID.SQL"
...
Select
  ...
  ERROR_REASON
from NCI_LABS
where LOAD_FLAG = 'W' AND PATIENT_ID = '&PTID'
order by
  RECORD_ID;
