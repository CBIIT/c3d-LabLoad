...
SPOOL NCI_LABS_LOADX_&PTID;

DEFINE studytitle =  "LAB_LOADER - NCI_LABS - LOAD FLAG=X - Patient &&PTID"
DEFINE filename = "File: NCI_LABSS_LOADX_PTID"
DEFINE Progname = "SQl script: NCI_LABS_LOADX_PTID.SQL"
...
Select
  ...
  ERROR_REASON
from NCI_LABS
where LOAD_FLAG = 'X' AND PATIENT_ID = '&PTID'
order by
  CDW_RESULT_ID,
  RECORD_ID;
