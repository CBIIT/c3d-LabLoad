...
SPOOL DCM_SUBSET_DCI;

DEFINE studytitle =  "LAB_LOADER - DCIs linked to NCI_LABS LAB_PANEL and SUBSET"
DEFINE filename = "File: DCM_SUBSET_DCI"
DEFINE Progname = "SQl script: DCM_SUBSET_DCI.SQL"
