...
-- Wait for the job to complete...
             ...
             loop
                ...
                if exe_status = 'SUCCESS' then
                  vStatus :='SUCCESS';
                  ops$bdl.cdw_data_transfer_v4.Update_After_Batch_Load;
                  ...
                  ops$bdl.cdw_data_transfer_v4.Update_After_Batch_Load; -- prc 07/10/03 -- prc 03/05/2004
                  exit;
                elsif exe_status = 'SUBMITTED' and
                  (sysdate - start_time) * 1440 > 30 then -- prc 07/10/03: Upped to 30 Minutes.
                  vStatus :='FAILURE';
                  ops$bdl.cdw_data_transfer_v4.Update_After_Batch_Load;
                  exit;
                end if;
